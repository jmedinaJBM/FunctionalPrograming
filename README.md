...
'''**_(T  param) -> R_**'''; puede apreciarse el operador Lamda formado por el guión junto con el símbolo mayor que: __->__.  Los paréntesis son parte de la expresión. Sin el operador Lamda, en Java se ve así: **_R  apply(T param)_**.  
